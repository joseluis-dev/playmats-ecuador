...
export const Cart = () => {
  ...
  return (
    <a href="/cart" className="relative hover:bg-[var(--color-surface)] transition-all duration-300 ease-in-out rounded-md p-2 z-100">
      <span className="absolute flex justify-center items-center top-0 right-0 text-xs rounded-full bg-[var(--color-primary)] w-5 h-5 text-[var(--color-text)]">{totalItems}</span>
